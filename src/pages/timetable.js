...
const TimeTable = ({
    ...
    return (
        <div className="sec">
            ...
            <div>
                <button className={show ? 'conf_work_button':'conf_work_button_not_show'} onClick={()=>setShow(true)}>Workshop</button>
                <button className={!show ? 'conf_work_button':'conf_work_button_not_show'} onClick={()=>setShow(false)}>Conference</button>
            </div>
            {
                show && <div>{wd.map(events => (
                    <div className="grid">
